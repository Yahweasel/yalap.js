...
Module.write_set_format_pax = Module.cwrap("archive_write_set_format_pax", "number", ["number"]);
Module.write_set_format_pax_restricted = Module.cwrap("archive_write_set_format_pax_restricted", "number", ["number"]);
